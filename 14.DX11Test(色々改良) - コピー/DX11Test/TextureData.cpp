...
void TextureData::Initialize()
{
	...
	DirectX::CreateWICTextureFromFile(Dx11::Instance()->m_pDevice, L"Texture/HARD_BLOCK.png"  , &m_pHARD_BLOCK_TR  , &m_pHARD_BLOCK_TSRV );
...
TextureData::~TextureData()
{
	...
	if (m_pHARD_BLOCK_TR      != nullptr) { m_pHARD_BLOCK_TR      -> Release(); m_pHARD_BLOCK_TR      = nullptr; }
	if (m_pHARD_BLOCK_TSRV    != nullptr) { m_pHARD_BLOCK_TSRV    -> Release(); m_pHARD_BLOCK_TSRV    = nullptr; }
